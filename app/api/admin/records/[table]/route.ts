...
export async function GET(
  ...
  try {
    ...
    console.error("[Route] GET /api/admin/records/[table] error", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[Route] PATCH /api/admin/records/[table] error", error);
    return NextResponse.json(
      { error: error instanceof Error ? error.message : String(error) },
      { status: 500 },
    );
...
export async function POST(
  ...
  try {
    ...
    console.error("[Route] POST /api/admin/records/[table] error", error);
    return NextResponse.json(
      { error: error instanceof Error ? error.message : String(error) },
      { status: 500 },
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[Route] DELETE /api/admin/records/[table] error", error);
    return NextResponse.json(
      { error: error instanceof Error ? error.message : String(error) },
      { status: 500 },
    );
